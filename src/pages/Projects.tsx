  ...
  const projects: Project[] = [
    {
      ...
      description: "I worked with a 12 developer team over the 2022-2023 school year to create a database management application for a local nonprofit, Get Inspired, to manage their Pismo clam preservation data.",
    ...
    },
    {
      ...
      description: "Knucklebones is a Python recreation of the KnuckleBones minigame from Cult of the Lamb.",
