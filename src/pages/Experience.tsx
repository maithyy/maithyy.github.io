...
const Experience = () => {
      ...
      roles: [
        {
          ...
          bullets: ["Managed meeting minutes and internal documentation"],
        },
        {
          roleTitle: "Public Relations Committee Member",
          date: "Nov 2021 - Jun 2023",
          bullets: ["Assisted in organizing and promoting student events"],
        },
      ],
    },
    {
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.singleColumnContainer}>{renderContent()}</div>
    </div>
  );
};
